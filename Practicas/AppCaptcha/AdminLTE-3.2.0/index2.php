...
while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='editar.php?id=". $row['Matricula'] ."' title='Actualizar' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'>
                                           

                                            </span></a>";
                                        echo "</td>";
                                        echo "<td>";
                                            echo "<a href='delete.php?id=". $row['Matricula'] ."' title='Borrar' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
?>
