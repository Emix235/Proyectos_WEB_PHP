...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
     <form method="post">
          <button type="submit"><!-- <i class="fa fa-car" style="font-size:48px;"> -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <iframe src="F1.html" width="100%" style="border:0; margin-top: 58px; overflow: hidden; width: -webkit-fill-available; top: 0; left: 0; right: 0; height: 1000px;" name="Contenido"></iframe>
          </div>
