...
<style>
        #datos tr.noSearch {background:#00bcd4;font-size:0.8em;}
        #datos tr.noSearch td {padding-top:10px;text-align:center;font-size: x-large;}
        .hide {display:none;}
        .red {color:Red;}
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <table class="table-box" id="datos">
<tr>
<th><b>Matricula</b></th>  
<th><b>Nombre</b></th>
<th><b>Apellido</b></th>
...
while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        echo "<td class='select'>" . $row['Matricula'] . "</td>";
                                        echo "<td class='select'>" . $row['Nombre'] . "</td>";
                                        echo "<td class='select'>" . $row['ApellidoP'] . "</td>";
                                        echo "<td class='select'>" . $row['usuario'] . "</td>";
                                        echo "<td>";
                                            echo "<a href='editar.php?id=". $row['Matricula'] ."' title='Actualizar' data-toggle='tooltip'>
                                              <i class='fa-solid fa-pen-to-square fa-lg'></i></a>";
                                        echo "</td>";
                                        echo "<td>";
                                            echo "<a href='delete.php?id=". $row['Matricula'] ."' title='Borrar' data-toggle='tooltip'>
